...
function ggr_portal_get_audit_field_labels() {
    return array(
        ...
        'ggr_collecting_extra_required' => 'Aanvullende stap actief',
        'ggr_collecting_extra_label'    => 'Aanvullende vraag',
        'ggr_collecting_extra_upload_label' => 'Aanvullende upload label',
        'ggr_collecting_extra_comment'  => 'Aanvullende toelichting (profiel)',
        'ggr_collecting_extra_response' => 'Aanvullend antwoord lead',
...
function ggr_portal_get_participant_audit_snapshot( $user_id ) {
    ...
    $snapshot = array(
        ...
        'ggr_greeting_name'         => $safe_meta( 'ggr_greeting_name' ),
        ...
        'ggr_collecting_extra_required' => $safe_meta( 'ggr_collecting_extra_required', 0 ),
        'ggr_collecting_extra_label'    => $safe_meta( 'ggr_collecting_extra_label' ),
        'ggr_collecting_extra_upload_label' => $safe_meta( 'ggr_collecting_extra_upload_label' ),
        'ggr_collecting_extra_comment'  => $safe_meta( 'ggr_collecting_extra_comment' ),
        'ggr_collecting_extra_response' => $safe_meta( 'ggr_collecting_extra_response' ),
