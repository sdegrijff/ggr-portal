...
function ggr_portal_render_email_template_metabox( $post ) {
    ...
    $available_placeholders = array(
        ...
        'lead_first_name'          => 'Voornaam van lead',
        'lead_last_name'           => 'Achternaam van lead',
        'lead_full_name'           => 'Volledige naam van lead',
        'lead_email'               => 'E-mailadres van lead',
        'lead_phone'               => 'Telefoonnummer van lead',
        'lead_nationality'         => 'Nationaliteit van lead',
        'lead_investment_amount'   => 'Investeringsbedrag van lead',
        'lead_account_type'        => 'Account type van lead (private/business)',        
        'lead_marketing_optin'     => 'Marketing opt-in van lead (ja/nee)',
        'lead_terms_accepted'      => 'Voorwaarden geaccepteerd (ja/nee)',  
        ...
        if ( $test_email && is_email( $test_email ) ) {
            ...
            if ( $post && $post->post_type === 'ggr_email_template' ) {
                ...
                $placeholders = [
                    ...
                    'lead_last_name'           => 'Gebruiker',
                    'lead_full_name'           => 'Test Gebruiker',
                    'lead_email'               => 'lead@example.com',
                    'lead_phone'               => '0612345678',
                    'lead_nationality'         => 'Nederlandse',
                    'lead_investment_amount'   => '€ 50.000',
                    'lead_account_type'        => 'private',
                    'lead_marketing_optin'     => 'ja',
                    'lead_terms_accepted'      => 'ja',                    
